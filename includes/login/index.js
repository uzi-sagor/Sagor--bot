...
function buildAPI(globalOptions, html, jar) {
		...
		if (!userCookie && !tiktikCookie) {
				return console.error('login', "No cookie found for user, please check login information again");
		}
		if (html.includes("/checkpoint/block/?next")) {
				return console.error('login', "Appstate dead, please replace with a new one!", 'error');
		}
